   ...
   public class Main:BaseSection
    {
        ...
        public string QuoteText()=> Scope.FindElement(By.CssSelector(".site-content q")).Text;

        public void ClickFeedbackLink(string link) => Scope.FindElement(By.XPath($"./p[@class='thank'][.='{link}']"))
            .Click();

        public void ClickButton(string button) => Scope.FindElement(By.CssSelector($"//input[@value='{button}']"))
            .Click();
       ...
       public void FillInName(string value) => Scope.FindElement(By.CssSelector("input#Name")).SendKeys(value);
        ...
        public ReadOnlyCollection<IWebElement> Comments => Scope.FindElements(By.CssSelector("blockquote"));
